// Rakesh-voiced variant of pilot-qotw1 — same captions/beats machinery,
// narration from the cloned Rakesh voice (takes in vo/pilot-qotw1-rakesh).
