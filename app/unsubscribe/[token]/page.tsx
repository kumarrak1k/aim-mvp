        ...
        {result.ok ? (
          <>
            ...
            <Link
              ...
              className="mt-6 inline-flex items-center justify-center rounded-2xl bg-gradient-to-r from-purple-500 via-fuchsia-500 to-blue-500 px-6 py-3 text-sm font-black text-white shadow-lg transition hover:scale-[1.02]"
            >
          ...
          <>
            ...
            <Link
              href="/account/notifications"
              className="mt-6 inline-flex items-center justify-center rounded-2xl border border-white/10 bg-white/[0.05] px-6 py-3 text-sm font-black text-white transition hover:bg-white/[0.1]"
            >
