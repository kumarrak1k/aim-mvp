              ...
              <form onSubmit={(e) => void handleSubmit(e)} className="mt-6 space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="mt-1.5 w-full rounded-xl border border-white/10 bg-recess-40 px-4 py-3 text-sm text-white placeholder:text-gray-400 focus:border-fuchsia-400/40 focus:outline-none disabled:opacity-50"
