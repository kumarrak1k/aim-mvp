  ...
  return (
    <div className="relative min-h-screen bg-background text-white">
      ...
      <header className="relative z-50">
        {/* 1200–1440 (nav visible, space tight): three auto columns with
            space-between — equal gaps logo↔nav↔actions. ≥1440: equal-1fr
            flanks PAGE-centre the nav pill so it aligns with the centred
            hero below (the ~800px candidate nav + auth cluster need that
            much room; measured 2026-08-31). */}
        <div className="relative mx-auto grid w-full max-w-7xl xl:max-w-[clamp(80rem,95vw,105rem)] grid-cols-[auto_minmax(0,1fr)_auto] items-center px-4 pt-1.5 pb-3 sm:px-6 sm:pt-2 sm:pb-4 lg:px-10 min-[1200px]:grid-cols-[auto_auto_auto] min-[1200px]:justify-between min-[1440px]:grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)]">
