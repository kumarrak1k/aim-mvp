 ...
 *
 * It is the page's largest image and sits in the first screen, so it is
 * fetched at high priority, in the viewer's theme. sizes matches the column it renders in: 7/12 of the content
