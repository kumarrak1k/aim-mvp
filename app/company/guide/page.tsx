      ...
      <div className="mx-auto max-w-3xl px-4 pb-20 pt-6 sm:px-6">
        ...
        <div className="mb-12 text-center">
          ...
          <h1 className="mt-2 text-4xl font-black tracking-[-0.04em] sm:text-5xl">
            ...
            <span className="bg-gradient-to-r from-fuchsia-300 via-purple-200 to-cyan-200 bg-clip-text text-transparent">
              six steps.
            </span>
          </h1>
        ...
        <div className="mt-14 rounded-[1.75rem] border border-fuchsia-400/20 bg-gradient-to-br from-fuchsia-600/20 via-purple-600/10 to-transparent p-8 text-center">
          <h2 className="text-2xl font-black tracking-[-0.03em]">Run your first assessment.</h2>
          ...
          <Link
            ...
            className="mt-5 inline-block rounded-full bg-gradient-to-r from-fuchsia-500 via-purple-500 to-blue-500 px-8 py-3 text-sm font-black text-white shadow-lg shadow-purple-950/40 transition hover:scale-[1.02]"
          >
            Create a template
          </Link>
        </div>
