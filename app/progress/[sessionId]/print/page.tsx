...
export default function SessionPrintPage() {
  ...
  return (
    <div className="report mx-auto min-h-screen max-w-3xl bg-white px-8 py-10 text-gray-900">
      ...
      {loading && <p className="text-sm text-gray-600">Loading your session…</p>}
      ...
      {session && (
        <>
          ...
          <Section title="Question-by-question review">
            {results.length === 0 && (
              <p className="text-sm text-gray-600">No question-level results were saved.</p>
            )}
  ...
  return (
    <div className="avoid-break">
      <div className="mb-1 flex justify-between text-sm">
        ...
        <span className="font-semibold text-gray-600">{v}/10</span>
      </div>
