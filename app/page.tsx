          ...
          <div className="flex items-center gap-3">
            <Show when="signed-out">
              <SignInButton mode="modal">
                <button className="rounded-full border border-white/10 bg-white/[0.06] px-5 py-2 text-sm font-semibold hover:bg-white/[0.1]">
                  Sign In
                </button>
              </SignInButton>
            </Show>
            ...
            <Link href="/practice">
              <button className="rounded-full bg-white px-5 py-2 text-sm font-semibold text-black hover:bg-purple-100">
                Start Practice
              </button>
            </Link>
          </div>
