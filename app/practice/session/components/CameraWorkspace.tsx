...
export function CameraWorkspace({
  ...
  return (
    <section className="rounded-[1.25rem] border border-white/10 bg-white/[0.055] p-3 shadow-2xl shadow-purple-950/10 backdrop-blur-2xl">
      ...
      <div className="relative mx-auto aspect-square max-h-[132px] w-full overflow-hidden rounded-[1rem] border border-white/10 bg-black shadow-xl shadow-black/20 sm:max-h-[140px]">
        <video
          ref={videoRef}
          autoPlay
          muted
        ...
        {cameraEnabled && !cameraRequiresTap && (
          <div className="pointer-events-none absolute inset-0 rounded-[1rem] border border-white/10" />
        )}
