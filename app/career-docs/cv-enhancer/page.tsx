      ...
      <CandidateAppShell currentPath="/career-docs">
        <div className="mx-auto max-w-lg px-4 py-24 text-center">
          ...
          <p className="mt-3 text-sm leading-7 text-gray-400">
            CV Enhancer is part of Pro, along with CV analysis, cover letters and
      ...
      <div className="mx-auto max-w-7xl xl:max-w-[clamp(80rem,95vw,105rem)] px-4 py-8 sm:px-6">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[12px] font-bold tracking-wide text-purple-300">AI Analysis</p>
            ...
            <div className="rounded-[1.75rem] border border-white/[0.07] bg-white/[0.04] p-6 backdrop-blur-xl space-y-4">
              ...
              <div>
                <label className="mb-1.5 block text-xs font-bold tracking-wide text-gray-400">
                  Your CV *
                  <span className="ml-2 text-[12px] font-semibold normal-case tracking-normal text-gray-400">paste plain text or upload a file</span>
                </label>
                ...
                {!savedCV.loading && (
                  <div className="mb-2 flex flex-wrap items-center gap-2 rounded-xl border border-purple-400/20 bg-purple-400/[0.06] px-3 py-2">
                    ...
                    <span className="flex-1 truncate text-[12px] font-semibold text-purple-300">
                      {savedCV.hasSavedCV
                        ? savedCV.cvFileName
                    ...
                    <div className="flex shrink-0 items-center gap-1.5">
                      <button
                        ...
                        className="rounded-lg border border-purple-400/30 bg-purple-400/10 px-2.5 py-1 text-[12px] font-bold text-purple-300 transition hover:bg-purple-400/20 disabled:opacity-50"
                      >
                    ...
                    <div className="flex shrink-0 items-center gap-1.5">
                      {savedCV.hasSavedCV && (
                        <button
                          ...
                          className="rounded-lg border border-white/10 bg-white/[0.04] px-2.5 py-1 text-[12px] font-bold text-gray-400 transition hover:text-white"
                        >
                          Undo edits
                        </button>
                      )}
                      <button
                        ...
                        className="rounded-lg border border-amber-400/30 bg-amber-400/10 px-2.5 py-1 text-[12px] font-bold text-amber-300 transition hover:bg-amber-400/20 disabled:opacity-50"
                      >
          ...
          <div className="space-y-4">
            ...
            {result && (
              <>
                ...
                <div className="rounded-[1.75rem] border border-white/[0.07] bg-white/[0.04] p-6 backdrop-blur-xl">
                  ...
                  <div className="mt-4 grid gap-3 sm:grid-cols-2">
                    <div className="rounded-xl border border-emerald-400/20 bg-emerald-400/[0.06] p-3">
                      <p className="text-[12px] font-bold tracking-wide text-emerald-400">Top strength</p>
                    ...
                    <div className="rounded-xl border border-amber-400/20 bg-amber-400/[0.06] p-3">
                      <p className="text-[12px] font-bold tracking-wide text-amber-400">Biggest gap</p>
                ...
                {/* Quick wins */}
                <div className="rounded-[1.75rem] border border-white/[0.07] bg-white/[0.04] p-6 backdrop-blur-xl">
                  <p className="mb-4 text-[12px] font-bold tracking-wide text-purple-300">Quick wins: do these first</p>
                  <ol className="space-y-2.5">
                    {result.quickWins.map((w, i) => (
                      <li key={i} className="flex items-start gap-3 text-sm text-gray-300">
                        <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-purple-400/20 text-[12px] font-bold text-purple-300">{i + 1}</span>
                        {w}
                      </li>
                    ))}
                  </ol>
                ...
                {/* Section breakdown */}
                <div className="rounded-[1.75rem] border border-white/[0.07] bg-white/[0.04] p-6 backdrop-blur-xl">
                  <p className="mb-4 text-[12px] font-bold tracking-wide text-gray-400">Section breakdown</p>
                ...
                {result.enhancedBullets.length > 0 && (
                  <div className="rounded-[1.75rem] border border-white/[0.07] bg-white/[0.04] p-6 backdrop-blur-xl">
                    <p className="mb-4 text-[12px] font-bold tracking-wide text-cyan-300">Rewritten bullet points</p>
                    <div className="space-y-5">
                      {result.enhancedBullets.map((b, i) => (
                        <div key={i} className="space-y-2">
                          <div className="rounded-lg border border-white/[0.06] bg-white/[0.03] px-3 py-2">
                            <p className="text-[12px] font-bold tracking-wide text-gray-400 mb-1">Before</p>
                          ...
                          <div className="rounded-lg border border-emerald-400/20 bg-emerald-400/[0.05] px-3 py-2">
                            <div className="mb-1 flex items-center justify-between gap-3">
                              <p className="text-[12px] font-bold tracking-wide text-emerald-400">After</p>
                              <button
                                onClick={() => copyText(b.enhanced, `bullet-${i}`)}
                                className="shrink-0 rounded-md border border-white/10 bg-white/[0.06] px-2 py-0.5 text-[12px] font-bold text-gray-400 hover:text-white transition"
                              >
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="rounded-[1.75rem] border border-white/[0.07] bg-white/[0.04] p-6 backdrop-blur-xl">
                    <p className="mb-3 text-[12px] font-bold tracking-wide text-amber-300">Keywords to add</p>
                  ...
                  <div className="rounded-[1.75rem] border border-white/[0.07] bg-white/[0.04] p-6 backdrop-blur-xl">
                    <p className="mb-3 text-[12px] font-bold tracking-wide text-blue-300">ATS tips</p>
          ...
          <div className="mt-6 space-y-4">
            ...
            {!checkingGaps && gaps === null && !generatingEnhanced && !enhancedResult && (
              <div className="rounded-[1.75rem] border border-purple-400/25 bg-gradient-to-br from-purple-500/[0.09] to-fuchsia-500/[0.04] p-6">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    <p className="mb-1 text-[12px] font-bold tracking-wide text-purple-400">Pro feature</p>
            ...
            {gaps !== null && gaps.length > 0 && !generatingEnhanced && !enhancedResult && (
              <div className="rounded-[1.75rem] border border-purple-400/20 bg-white/[0.03] p-6">
                <div className="mb-5">
                  <p className="text-[12px] font-bold tracking-wide text-purple-300">Before we generate</p>
                  <p className="mt-1 text-sm leading-6 text-gray-400">
                      ...
                      >
                        <div className="flex items-start gap-3">
                          <div className="min-w-0 flex-1">
                            <p className="mb-0.5 text-[12px] font-bold tracking-wide text-purple-400">{gap.section}</p>
                          ...
                          <button
                            ...
                            className="mt-0.5 shrink-0 rounded-lg border border-white/10 bg-white/[0.04] px-3 py-1.5 text-[12px] font-bold text-gray-400 transition hover:text-gray-300"
                          >
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-[1.75rem] border border-white/[0.07] bg-white/[0.04] p-6">
                  <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
                    ...
                    <div className="flex gap-2">
                      <span className="rounded-full bg-emerald-500/20 px-2.5 py-1 text-[12px] font-bold text-emerald-300">
                        {enhancedResult.changes.length - rejectedIds.size} accepted
                      </span>
                      <span className="rounded-full bg-red-500/20 px-2.5 py-1 text-[12px] font-bold text-red-300">
                        ...
                        >
                          <div className="flex items-start gap-3">
                            <div className="min-w-0 flex-1">
                              ...
                              <p className="mt-2 text-[12px] leading-4 text-gray-400">→ {change.reason}</p>
                            </div>
                            <button
                              onClick={() => toggleRejection(change.id)}
                              className={`shrink-0 rounded-lg border px-3 py-1.5 text-[12px] font-bold transition ${
                                rejected
                ...
                {enhancedResult.flagged.length > 0 && (
                  <div className="rounded-[1.75rem] border border-amber-400/20 bg-amber-400/[0.04] p-6">
                    <p className="mb-3 text-[12px] font-bold tracking-wide text-amber-300">
                ...
                <div className="rounded-[1.75rem] border border-white/[0.07] bg-white/[0.04] p-6">
                  <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
                    <div>
                      <p className="text-[12px] font-bold tracking-wide text-cyan-300">Your enhanced CV</p>
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="rounded-xl border border-cyan-400/30 bg-cyan-400/10 px-4 py-2 text-[12px] font-bold text-cyan-300 transition hover:bg-cyan-400/20"
                      >
                      ...
                      <button
                        ...
                        className="rounded-xl border border-white/10 bg-white/[0.04] px-4 py-2 text-[12px] font-bold text-gray-400 transition hover:text-white"
                      >
                        Regenerate
                      </button>
                    </div>
