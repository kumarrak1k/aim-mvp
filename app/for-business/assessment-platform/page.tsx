      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 sm:pb-20">
        <div className="space-y-5 lg:grid lg:grid-cols-2 lg:gap-5 lg:space-y-0">
          {workflow.map((step) => (
            <div
              key={step.number}
              className="rounded-[1.85rem] border border-fuchsia-500/[0.18] bg-fuchsia-500/[0.04] p-7"
            >
              <p className="text-3xl font-black leading-none text-fuchsia-500/40">
                {step.number}
              </p>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-20 sm:px-6 sm:pb-28">
        <div className="rounded-[2rem] border border-white/[0.1] bg-gradient-to-br from-fuchsia-500/[0.10] via-purple-500/[0.06] to-transparent p-10 text-center sm:p-14">
          ...
          <div className="mt-7 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <Link href="/for-business/sign-up">
              <button className="rounded-2xl bg-gradient-to-r from-fuchsia-500 to-purple-500 px-7 py-4 text-base font-black text-white shadow-2xl shadow-fuchsia-900/40 transition hover:scale-[1.02]">
                Create workspace →
              </button>
            </Link>
            <Link href="/for-business/pricing">
